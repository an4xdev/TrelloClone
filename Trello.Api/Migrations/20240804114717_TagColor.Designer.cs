...
namespace Trello.Api.Migrations
{
    ...
    [Migration("20240804114717_TagColor")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trello.Api.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DoneDate = new DateOnly(2024, 8, 4),
                            Name = "Pet capybara",
                            ProjectID = 1
                        });
                });
            ...
            modelBuilder.Entity("Trello.Api.Models.TagColor", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Trello.Api.Models.Tag", b =>
                {
                    b.HasOne("Trello.Api.Models.TagColor", "TagColor")
                        .WithMany("Tags")
